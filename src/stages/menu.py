...
def menu():
    ...
    new_game_button = Entity(Label("undertale-small-font-cyrillic.otf", "New Game", 88, (255, 255, 0)))
    quit_game_button = Entity(Label("undertale-small-font-cyrillic.otf", "Quit", 80, (255, 255, 0)))
